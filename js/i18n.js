...
(function () {
  const MESSAGES = {
    en: {
      ...
      "status.gpuMissing": "No NVIDIA GPU detected",
      ...
      "form.experimentalNote": "Effects force a re-encode and override the normal quality and encoding settings.",
      "form.effect": "Video effect",
      "form.audioEffect": "Audio effect",
      ...
      "about.desc": "Grabtify is a DaVinci Resolve Workflow Integration plugin for " +
        "Windows. Paste a link, it downloads the clip with yt-dlp, optionally trims " +
        "it, and drops it onto your timeline.",
      ...
      "settings.gpuAccel": "GPU acceleration (NVIDIA)",
      "settings.gpuNote": "Detects your NVIDIA GPU and encodes with the hardware encoder for much faster imports. Falls back to CPU if unavailable.",
      "gpu.auto": "Auto (use GPU when available)",
      "gpu.on": "On (NVIDIA always)",
      "gpu.off": "Off (CPU)",
      "settings.saveTo": "Save downloads to",
      "settings.browse": "Choose…",
      "settings.recheck": "Check again",
      "settings.checkUpdates": "Check for updates",
      "settings.upToDate": "All up to date!",
      "settings.foundUpdates": "Updates available!",
      "settings.rechecked": "Checked",
      "settings.toolsTitle": "Tools this panel drives",
      "settings.about": "About",
      "settings.creator": "Created by Pedro Gottardi",
      ...
      "settings.roleGpu": "NVIDIA GPU",
      "settings.summary": "Ready: {0} of {1}",
      "settings.support": "Support the project",
      "settings.kofi": "Buy me a coffee!",
      "settings.verboseLog": "Detailed log",
      "settings.verboseLogNote": "Shows full file paths and raw tool output.",
      ...
      "fx.off": "Off (no effect)",
      "fx.smear": "Datamosh - smear (1 pass)",
      "fx.mosh": "Datamosh - true (2 passes)",
      "fx.glitch": "Glitch / RGB split",
      "fx.vhs": "VHS (lo-fi audio)",
      "fx.pixel": "Pixel / tiny resolution",
      "fx.tiny240": "Very small (240p)",
      "fx.poster": "Posterize / 8-color dither",
      "fx.noir": "Grainy B&W / noir",
      "fx.crt": "CRT scanlines",
      "fx.trail": "Motion trails",

      "af.off": "Off (no effect)",
      "af.echo": "Echo",
      "af.reverb": "Reverb hall",
      "af.radio": "Radio / telephone",
      "af.nightcore": "Nightcore (speed up)",
      "af.deep": "Deep / slowed down",
      "af.bass": "Bass boost",
      "af.tremolo": "Tremolo",
      "af.crush": "Bitcrush",
      "af.reverse": "Reverse",
      ...
      "job.usingGpu": "GPU encoding enabled (NVIDIA h264_nvenc).",
      "job.usingGpuFallback": "GPU encoding failed — retrying with CPU.",
      "job.moshPrep": "Preparing datamosh stream…",
      ...
      "job.savedTo": "Saved to: {0}",
      "job.convertingVideo": "Converting video…",
      "job.convertingAudio": "Converting to MP3…",
      "job.trimmingTo": "Cutting to {0}–{1}",
      "job.toolMissing": "A required tool could not be started. Reinstall Grabtify and try again.",
      "job.downloadFailed": "The download failed.",
      "job.encodeFailed": "The video could not be converted.",
      "job.gpuFallback": "GPU unavailable — using the CPU instead.",
    ...
    "pt-BR": {
      ...
      "status.gpuMissing": "Nenhuma GPU NVIDIA detectada",
      ...
      "form.experimental": "Experimental",
      "form.experimentalNote": "Efeitos forçam uma recodificação e substituem a qualidade e as configurações normais de codificação.",
      "form.effect": "Efeito de vídeo",
      "form.audioEffect": "Efeito de áudio",
      ...
      "about.desc": "O Grabtify é um plugin de Workflow Integration para o DaVinci " +
        "Resolve no Windows. Cole um link, ele baixa o clipe com o yt-dlp, " +
        "opcionalmente corta e insere na sua timeline.",
      "about.version": "Versão",
      "about.author": "Criado por",
      "about.website": "Site",
      "about.github": "GitHub",
      ...
      "settings.gpuAccel": "Aceleração por GPU (NVIDIA)",
      "settings.gpuNote": "Detecta sua GPU NVIDIA e codifica com o encoder de hardware para importações muito mais rápidas. Volta para a CPU se indisponível.",
      "gpu.auto": "Automático (usa GPU quando disponível)",
      "gpu.on": "Ligado (sempre NVIDIA)",
      "gpu.off": "Desligado (CPU)",
      ...
      "settings.upToDate": "Tudo em dia!",
      "settings.foundUpdates": "Atualizações disponíveis!",
      "settings.rechecked": "Verificado",
      "settings.toolsTitle": "Ferramentas usadas por este painel",
      "settings.about": "Sobre",
      "settings.creator": "Criado por Pedro Gottardi",
      "settings.roleResolve": "DaVinci Resolve",
      "settings.roleYtdlp": "Downloader",
      "settings.roleFfmpeg": "Codificador",
      "settings.roleDeno": "Runtime JS (YouTube)",
      "settings.roleGpu": "GPU NVIDIA",
      "settings.summary": "Prontos: {0} de {1}",
      "settings.support": "Apoie o projeto",
      "settings.kofi": "Me pague um café!",
      "settings.verboseLog": "Log detalhado",
      "settings.verboseLogNote": "Mostra caminhos completos e a saída bruta das ferramentas.",
      ...
      "fx.off": "Desligado (sem efeito)",
      "fx.smear": "Datamosh - rastro (1 passada)",
      "fx.mosh": "Datamosh - verdadeiro (2 passadas)",
      "fx.glitch": "Glitch / divisão RGB",
      "fx.vhs": "VHS (áudio lo-fi)",
      "fx.pixel": "Pixel / resolução minúscula",
      "fx.tiny240": "Muito pequeno (240p)",
      "fx.poster": "Posterizar / dither de 8 cores",
      "fx.noir": "P&B granulado / noir",
      "fx.crt": "Scanlines CRT",
      "fx.trail": "Rastros de movimento",

      "af.off": "Desligado (sem efeito)",
      "af.echo": "Eco",
      "af.reverb": "Reverberação (salão)",
      "af.radio": "Rádio / telefone",
      "af.nightcore": "Nightcore (acelerado)",
      "af.deep": "Grave / desacelerado",
      "af.bass": "Reforço de graves",
      "af.tremolo": "Tremolo",
      "af.crush": "Bitcrush",
      "af.reverse": "Inverter",
      ...
      "job.usingGpu": "Codificação por GPU ativada (NVIDIA h264_nvenc).",
      "job.usingGpuFallback": "Codificação por GPU falhou — tentando novamente com CPU.",
      "job.moshPrep": "Preparando stream de datamosh…",
      ...
      "job.savedTo": "Salvo em: {0}",
      "job.convertingVideo": "Convertendo vídeo…",
      "job.convertingAudio": "Convertendo para MP3…",
      "job.trimmingTo": "Cortando até {0}–{1}",
      "job.toolMissing": "Uma ferramenta necessária não pôde ser iniciada. Reinstale o Grabtify e tente de novo.",
      "job.downloadFailed": "O download falhou.",
      "job.encodeFailed": "Não foi possível converter o vídeo.",
      "job.gpuFallback": "GPU indisponível — usando a CPU.",
