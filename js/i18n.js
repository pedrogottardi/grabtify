...
(function () {
  const MESSAGES = {
    en: {
      ...
      "opt.downloadTrim": "During download (faster)",
      ...
      "job.downloadTrim": "Trimming at download: {0}s to {1}s (needs ffmpeg).",
    ...
    "pt-BR": {
      ...
      "opt.downloadTrim": "Durante o download (mais rápido)",
      ...
      "job.downloadTrim": "Cortando no download: {0}s a {1}s (precisa de ffmpeg).",
